<template>
    <div class="mb-6">
        <div class="relative">
            <textarea :rows="rows" @focusin="emit('inFocus')" v-model="model" :type="type" :id="id" :disabled="disabled"
            ...
            <label :for="id"
                class="absolute text-sm -top-2 bg-white duration-300 transform scale-75 z-10 origin-[0]  px-2 peer-focus:px-2  peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-5 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto start-1"
                :class="{
